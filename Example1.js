...
function OpenFormUpload(){
  ...
  var theLeft=((screen.width-600)/2);
  var features = `height=400,width=600,top=${theTop},left=${theLeft},toolbar=1,Location=0,Directories=0,Status=0,menubar=1,Scrollbars=1,Resizable=1`;
  window.open("https://script.google.com/macros/s/AKfycbx0cFrESkJgv8hGJ62LJlZRy2JjEgqTrkNWyawouAOfGSA146urO9cc-xXud8t4xofzhQ/exec","_blank",features);
 }
...
function onsubmitForm(){
  ...
  MainForm.action='https://script.google.com/macros/s/AKfycbxsiBN4dNjyCYT9S_Zw-_M9kJPF4YAiUeP1BRvw2t4Kg60BFUr0MhaJmJCZATP3HHru/exec'
  MainForm.submit();
